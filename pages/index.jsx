...
export default function Home() {
  return (
    <div className="container mx-auto">
      <PagesMetaHead
        title="Jainth Web Developer"
        description="Welcome to Jainth's portfolio! I'm a web developer passionate about creating beautiful and functional websites. Explore my projects and skills."
      />
